                    ...
                    switch (status.getStatusCode()) {
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                status.startResolutionForResult(Map.this, 1000);
                            } catch (IntentSender.SendIntentException e) {
                                // Ignore the error.
                            }
                            break;
                ...
                case 1000:
                    switch (resultCode) {
                        case Activity.RESULT_OK:
                            ...
                            in.putExtra("Longitude",_longitude.getText().toString());
                            in.putExtra("Latitude",_latitude.getText().toString());
                            setResult(1,in);
                            finish();
                            break;
        ...
        public void getLocation() {
            ...
            /*Getting the location after aquiring location service*/
                ...
                * For this we'll implement Location Listener and override onLocationChanged*/
                    ...
                    LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, Map.this);
                }
            }
        }
